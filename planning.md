...
**SAM Projects** measure students’ mastery of module learning objectives. Each project covers over 90% of the gradable module objectives and takes approximately 30-45 minutes to complete; the time will vary by student and number of steps. These projects are used as additional project practice to prepare you for the graded SAM CT Project and SAM Capstone project. SAM Projects take approximately 30-45 minutes to complete. (Plan 1.5 hours) 

**SAM CT Project** is a critical thinking activity and follows the same progression of steps, the same module objectives, and the same scenario as the SAM Projects. However, in SAM CT Project, the difficulty level is significantly increased from the SAM projects, with step instruction language that is intentionally designed to promote critical thinking. Use the SAM Projects as a guide. These projects will be the main resource to prepare you for the three semester Capstone Projects. SAM CT Projects take approximately 45-60 minutes to complete. (Plan 2 hours) 
